...
const Classroom = () => {
  return (
    <div>
      ...
      <div className="class_logo_div">
        <img
          src="https://files.codingninjas.in/explore-our-courses-illustration-27791.svg"
          alt="404"
          className="class_logo"
        />
        <h2> Boost your career with in-demand coding skills. Explore <br/>our coding courses. </h2>
        <Link to='/formclass'>
        <button className="class_btn">Explore Our Course </button>
        </Link>
        {/* <span className="span"><i class="fa-regular fa-arrow-up-right"></i></span> */}
      </div>
    </div>
  );
};
