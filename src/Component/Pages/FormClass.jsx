...
const FormClass = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://backend-codingninja.onrender.com/form", formData);
  ...
  return (
    <div>
      ...
      <div className="formContainer">
        {/* <img
        src="https://files.codingninjas.in/courses-page-top-bg-11535.svg"
        alt="404"
        className="formImg"
        /> */}
        <div className="formData">
          <h2>Welcome to Coding Ninja</h2>
          <div className="minus">
            <span>
